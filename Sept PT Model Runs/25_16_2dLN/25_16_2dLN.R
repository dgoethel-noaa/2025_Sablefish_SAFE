# Purpose: To create an RTMB model for the sablefish assessment using SPoRC to compare likelihoods (2d-Logistic-Normal; uses the natmort branch)
...
SPoRC_one_reg <- readRDS(here("Sept PT Model Runs", mod_name, "SPoRC_one_reg_age_joint_no_len_kp_JPN.rds"))
...
# Write out RDS file
saveRDS(sabie_rtmb_model, file = here("Sept PT Model Runs", mod_name, paste0(mod_name,"_model_results.RDS")))
saveRDS(input_list, file = here("Sept PT Model Runs", mod_name, paste0(mod_name,"_input_list.RDS")))
