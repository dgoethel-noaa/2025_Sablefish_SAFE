# Purpose: Spatial Sablefish Sensitivity Run - Multinomial Release Conditioned, Survey AI Catchability
...
# Share AI catchability
map_srv_q <- array(mapping$ln_srv_q, dim = dim(parameters$ln_srv_q))
map_srv_q[2,,c(1,3)] <- c(3,4)
mapping$ln_srv_q <- factor(map_srv_q)
