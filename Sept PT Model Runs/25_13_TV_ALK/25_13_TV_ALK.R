...
mod_name <- '25_13_TV_ALK'                                                    # Model name to use for saving files and labels
...
# Read in time-varying ALK
tv_alk <- readRDS(here("Sept PT Model Runs", "Data Files", "TV_AL_matrix.rds"))

# read in time-varying waa
tv_waa <- readRDS(here("Sept PT Model Runs", "Data Files", "TV_WAA_matrix.rds"))
