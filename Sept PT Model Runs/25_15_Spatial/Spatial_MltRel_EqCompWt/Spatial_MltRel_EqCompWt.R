# Purpose: Spatial Sablefish Sensitivity Run - Multinomial Release Conditioned, Equal composition weights
...
# Change up ISS
data$ISS_SrvAgeComps[] <- 35
data$ISS_FishAgeComps[] <- 35
data$ISS_FishLenComps[] <- 35
data$ISS_SrvLenComps[] <- 35
