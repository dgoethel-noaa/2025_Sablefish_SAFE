...
mod_name_main <- '25_1_SPoRC_Cont'                                                    # Model name to use for saving files and labels
...
comp_name <- "Cont_Retro"
do_francis <- 1                                                                # whether or not to do francis reweighting for this run, ==0 NO, ==1 YES
peels <- 7
do_mod_comp <- 0                                                               # whether to run comparison graphics with another model retro, if yes (==1) then need the associated rds files in the root folder (data, rep, sdrep, and mod_names)
