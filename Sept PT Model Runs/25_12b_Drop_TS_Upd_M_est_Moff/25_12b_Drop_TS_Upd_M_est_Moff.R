...
mod_name <- '25_12b_Drop_TS_Upd_M_est_Moff'                                                    # Model name to use for saving files and labels
...
input_list <- Setup_Mod_Biologicals(input_list = input_list,
                                    ...
                                    M_spec = NULL,                  # estimate a single M value (not sex, age, or region specific)
