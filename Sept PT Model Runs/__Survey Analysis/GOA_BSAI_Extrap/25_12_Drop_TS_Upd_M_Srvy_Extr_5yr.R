...
mod_name <- '5yr Extrap'                                                    # Model name to use for saving files and labels
root_folder <- "Sept PT Model Runs/_Survey Analysis/GOA_BSAI_Extrap"                                            # The root folder where runs will be stored (sub folders named with mod_name)
